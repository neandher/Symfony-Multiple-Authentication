...
namespace AppBundle\Security\Gestor;
...
class FormLoginAuthenticator extends AbstractFormLoginAuthenticator
{
     ...
     */
    private $gestorUserManager;

    public function __construct(Router $router, UserPasswordEncoder $passwordEncoder, GestorUserManager $gestorUserManager)
    {
        $this->router = $router;
        $this->passwordEncoder = $passwordEncoder;
        $this->gestorUserManager = $gestorUserManager;
    }
    ...
    {
        return $this->router->generate('gestor_security_login');
    }
    ...
    {
        return $this->router->generate('gestor_dashboard');
    }
    ...
    {
        if($request->getPathInfo() != '/gestor/login_check'){
            return;
        }
