...
class User extends AbstractTimestampable implements AdvancedUserInterface
{
     ...
     * @var GestorUser
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Gestor\Acesso\GestorUser", mappedBy="user")
     */
    private $gestorUser;
     ...
     * @var AdminUser
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Admin\Acesso\AdminUser", mappedBy="user")
     */
    private $adminUser;
     ...
     * @return GestorUser
     */
    public function getGestorUser()
    {
        return $this->gestorUser;
    }
